...
class LibraryRepoImpl : LibraryRepo {
    ...
    private val sampleArtists = listOf(
        LibraryArtist(1, "Luna Eclipse", 15, 2, R.drawable.img_1, "Electronic"),
        LibraryArtist(2, "Sunshine", 20, 3, R.drawable.img_2, "Pop"),
        LibraryArtist(3, "Poster Girl", 10, 1, R.drawable.img_3, "Rock"),
        LibraryArtist(4, "Disco Drive", 30, 4, R.drawable.img_4, "Disco")
    )

    private val sampleSongs = listOf(
        Song(1, "Katsee", "Luna Eclipse", R.drawable.img_1, 0, "Luna Eclipse", "2:50"),
        Song(2, "Miline", "Luna Eclipse", R.drawable.img_5, 0, "Luna Eclipse", "3:15"),
        Song(3, "Star", "Luna Eclipse", R.drawable.img_6, 0, "Luna Eclipse", "4:20"),
        Song(4, "Eclipse", "Luna Eclipse", R.drawable.img_7, 0, "Luna Eclipse", "3:45"),
        Song(5, "Moon", "Luna Eclipse", R.drawable.img_10, 0, "Luna Eclipse", "5:10")
    )
    ...
    override fun getAlbums(): List<Album> {
        return listOf(
            Album(1, "Luna Eclipse", "Electronic Vibes", R.drawable.img_1, 5, 2024),
            Album(2, "Sunshine", "Pop Collection", R.drawable.img_2, 8, 2023)
        )
    }
